...
#___________________________________________________________________________________________________________
#_______________________________________________________
#Figure 1: conceptual diagram (not in r)
#_______________________________________________________
#_______________________________________________________
#Figure 2: experimental design (not in r)
#_______________________________________________________
#_______________________________________________________
...
sp1<-plot_grid(s1,s2,s3,s4,s5,s6,s7,s8, ncol = 1, labels = c('(a)', '(b)', '(c)', '(d)','(e)','(f)', '(g)', '(h)'), label_size = 12)
sp1
sp2<-plot_grid(s1.1,s2.1,s3.1,s4.1,s5.1,s6.1,s7.1,s8.1, ncol = 1, labels = c('(i)', '(j)', '(k)', '(l)','(m)','(n)','(o)','(p)'), label_size = 12)
